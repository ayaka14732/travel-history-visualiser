...
export const COUNTRIES: CountryEntry[] = [
  ...
  c('AG', '安地卡及巴布達', 'Antigua and Barbuda', 'Antigua-et-Barbuda', 'Antigua og Barbuda', [
    '安提瓜和巴布达',
    '安地卡和巴布達',
  ]),
  ...
  c('CF', '中非共和國', 'Central African Republic', 'République centrafricaine', 'Centralafrikanske Republik', [
    '中非',
  ]),
  ...
  c('CG', '剛果共和國', 'Republic of the Congo', 'République du Congo', 'Republikken Congo', [
    '刚果共和国',
    '刚果（布）',
    '剛果（布）',
  ]),
  c('CD', '剛果民主共和國', 'DR Congo', 'République démocratique du Congo', 'Den Demokratiske Republik Congo', [
    '刚果民主共和国',
    '刚果（金）',
    '剛果（金）',
    '民主剛果',
  ...
  c('DO', '多明尼加共和國', 'Dominican Republic', 'République dominicaine', 'Den Dominikanske Republik', [
    '多明尼加',
    '多米尼加共和国',
  ]),
  ...
  c('CI', '象牙海岸', 'Ivory Coast', "Côte d'Ivoire", 'Elfenbenskysten', [
    '科特迪瓦',
    "côte d'ivoire",
    "cote d'ivoire",
  ]),
  ...
  // ── S ────────────────────────────────────────────────────────────────────
  c('KN', '聖克里斯多福及尼維斯', 'Saint Kitts and Nevis', 'Saint-Kitts-et-Nevis', 'Saint Kitts og Nevis', [
    '圣基茨和尼维斯',
  ]),
  ...
  c('ST', '聖多美普林西比', 'São Tomé and Príncipe', 'Sao Tomé-et-Príncipe', 'São Tomé og Príncipe', [
    '圣多美和普林西比',
  ]),
  ...
  c('AE', '阿聯酋', 'United Arab Emirates', 'Émirats arabes unis', 'De Forenede Arabiske Emirater', [
    '阿联酋',
    'uae',
    'emirates',
  ]),
  ...
  c('VG', '英屬維爾京群島', 'British Virgin Islands', 'Îles Vierges britanniques', 'Britiske Jomfruøer', [
    '英属维尔京群岛',
  ]),
  ...
  c(
    ...
    'South Georgia og South Sandwich-øerne',
  ),
...
export function getFlagEmoji(code: string): string | null {
  ...
  return String.fromCodePoint(0x1f1a5 + a.charCodeAt(0)) + String.fromCodePoint(0x1f1a5 + b.charCodeAt(0));
}
